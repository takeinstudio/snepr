...
import { ArrowRight, MapPin, Scissors, Search, Sparkles, Zap, Smartphone, LogIn } from "lucide-react";
          ...
          <div className="relative z-10 w-full max-w-md overflow-hidden rounded-[28px] border border-[#EFE7DC] bg-[#FAF8F5] p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-serif font-bold text-[#1C1613] tracking-tight mt-2">
                India's Live Salon Queue System
              </h2>
              <p className="text-xs text-[#6E6761] leading-relaxed max-w-sm">
                See live queues, join from your phone, and walk straight into the chair. 100% free for customers.
              </p>
            </div>
            ...
            <div className="mt-8 space-y-4">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 h-14 bg-[#7A4B29] hover:bg-[#60391F] text-white font-bold text-xs uppercase tracking-widest rounded-2xl shadow-lg shadow-[#7A4B29]/20 transition-all disabled:opacity-60"
              >
